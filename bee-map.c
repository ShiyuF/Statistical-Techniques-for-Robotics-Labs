int read_beesoft_map(char *mapName, map_type *map)
{
 ...
 // if Return value of strncmp = 0 then it indicates str1 is equal to str2
 // So the while() below starts reading each line from the wean.dat and extracts values 
 // for robot specifications untill it encounters global_map[0] at which it breaks
